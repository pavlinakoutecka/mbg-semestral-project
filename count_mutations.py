...
def count_mutations(input_file, output_file):
    """
...
def count_diff_sequences(input_file, output_file):
    """
...
if __name__ == "__main__":
    ...
    #output_file_name = f'mutations_counts/{number_of_sequences}s_mutations_counts.txt'
    #count_mutations(input_file_name, output_file_name)

    # ----- COUNT POSITION-DIFFERENT SEQUENCES
    #output_file_name = f'mutations_counts/{number_of_sequences}s_diff_seq_counts.txt'
    #count_diff_sequences(input_file_name, output_file_name)
